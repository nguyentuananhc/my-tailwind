...
function App() {
  return (
    <div className="mt-16 bg-white pb-12 lg:mt-20">
            ...
            <div className="relative lg:grid lg:grid-cols-10">
              <div className="max-w-lg mx-auto lg:max-w-none lg:mx-0 lg:col-start-4 lg:col-end-8 lg:row-start-1 lg:row-end-4">
                <div className="relative z-10 rounded-lg shadow-xl">
                  <div>
                    <div className="pointer-events-none absolute inset-0 rounded-lg border-2 border-teal-500" />
              ...
              <div className="mt-6 mt mx-auto max-w-md lg:m-0 lg:max-w-none lg:col-start-8 lg:col-end-11 lg:row-start-2 lg:row-end-3">
